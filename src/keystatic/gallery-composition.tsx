...
const contentBlockField = fields.object(
  {
    ...
    collageStyle: fields.select({
      ...
      { label: "山西 · 屋檐（紧凑）", value: "shanxi-eaves-full" },
      { label: "山西 · 殿内（紧凑）", value: "shanxi-hall-full" },
      { label: "山西 · 门槛（紧凑）", value: "shanxi-thresholds-full" },
      { label: "山西 · 石窟（紧凑）", value: "shanxi-grottoes-full" },
      { label: "山西 · 路途（紧凑）", value: "shanxi-passage-full" },
      ],
      defaultValue: "roof",
    }),
